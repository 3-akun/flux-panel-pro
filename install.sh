...
GOST_RELEASE_REPO="${GOST_RELEASE_REPO:-3-akun/flux-panel-pro}"
GOST_VERSION="${GOST_VERSION:-2.0.0}"

# 构建下载地址
build_download_url() {
    local ARCH=$(get_architecture)
    echo "https://github.com/${GOST_RELEASE_REPO}/releases/download/${GOST_VERSION}/gost-${ARCH}"
}
...
# 注：原 case 4 误调用未定义的 block_protocol，已修正为退出
