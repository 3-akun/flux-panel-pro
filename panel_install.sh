...
# 仓库配置（面板配置文件从 3-akun 主分支拉取；Docker 镜像暂用上游 bqlpfy）
FLUX_REPO="${FLUX_REPO:-3-akun/flux-panel}"
FLUX_BRANCH="${FLUX_BRANCH:-main}"
DOCKER_IMAGE_REPO="${DOCKER_IMAGE_REPO:-bqlpfy}"
DOCKER_IMAGE_VERSION="${DOCKER_IMAGE_VERSION:-1.4.3}"

DOCKER_COMPOSEV4_URL="https://raw.githubusercontent.com/${FLUX_REPO}/${FLUX_BRANCH}/docker-compose-v4.yml"
DOCKER_COMPOSEV6_URL="https://raw.githubusercontent.com/${FLUX_REPO}/${FLUX_BRANCH}/docker-compose-v6.yml"
GOST_SQL_URL="https://raw.githubusercontent.com/${FLUX_REPO}/${FLUX_BRANCH}/gost.sql"
